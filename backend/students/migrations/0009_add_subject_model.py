    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "name",
                    models.CharField(max_length=50, unique=True, verbose_name="과목명"),
                ),
            ],
        ...
        migrations.RenameField(
            model_name="user", old_name="subject", new_name="old_subject"
        ),
        migrations.RenameField(
            model_name="class", old_name="subject", new_name="old_subject"
        ),
        # 새 관계 필드 추가
        migrations.AddField(
            model_name="user",
